...
function ComprasMercadoForm({ open, onClose, onComplete }: ComprasMercadoFormProps) {
  // Logs de debug removidos temporalmente para evitar bucle infinito
  ...
  const agregarProducto = () => {
    ...
    // Log de debug removido temporalmente
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('✅ Iniciando guardado - Total productos:', productos.length);
